...
pages = {"Hem": home_page, "Karta": map_page,"Anordnare": Organizer, "Studenter": number_students_educationalarea_year, "Statsbidrag": government_grant_per_program}

if __name__=="__main__":
    Gui(pages=pages, css_file= "assets/style.css").run(port=8080, 
                                                       dark_mode=True, 
                                                       use_reloader=True, 
