...
start_year = ""
end_year = ""
selected_educational_area_students = []            # added students, was same name in government grants 
kpi_mean = "-"
kpi_peak_year = "-"
kpi_peak_year_value = "-"
kpi_top_area = "-"
...
try:
    df = read_csv_alex(
        sub_category="2024_kurser", file_name="studerande_examinerad_yrkeshogskola.csv"
    )
        ...
        with tgb.part(class_name="card card-margin"):
            with tgb.layout(columns="3 2 1"):
                with tgb.part(class_name="education_area_filter"):
                    tgb.selector(
                        value="{selected_educational_area_students}",           #added students, was same name in government grants 
